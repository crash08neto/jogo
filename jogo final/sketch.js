...
function draw() {
  ...
  if(estadoDeJogo === "play"){
    ...
    zumbig.setVelocityEach(0, 0)
    meteorg.setVelocityEach(0, 0)
    /*zumbig.setVelocityYEach(0)
    meteorg.setVelocityYEach(0)*/

    zumbig.setLifetimeEach(-1)
  ...
  if(estadoDeJogo === "end"){
    text("você não vive mais", 200, 300)
  }
}
